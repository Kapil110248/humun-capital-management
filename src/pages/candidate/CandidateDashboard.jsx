    ...
    <div className="space-y-8 pb-12 animate-fade-in max-w-7xl mx-auto">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div className="text-left">
          ...
          <p className="text-slate-500 font-bold tracking-tight uppercase text-xs mt-1">Welcome Back • {profile.fullName}</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-8 space-y-8">
          <div className="card p-0 border-none bg-white shadow-soft overflow-hidden">
            <div className="flex items-center justify-between p-8 border-b border-slate-50 bg-slate-50/20">
               <div>
                  <h2 className="text-2xl font-black text-slate-900 italic tracking-tight leading-none mb-2">Recent Applications</h2>
                  <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Tracking your application history</p>
               </div>
              ...
              <table className="w-full text-left">
                <thead>
                  <tr className="bg-slate-50/50">
                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em]">Job Role</th>
                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-center">Applied On</th>
                    <th className="px-8 py-5 text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] text-center">Application Status</th>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card border-none bg-slate-900 p-10 overflow-hidden relative group shadow-premium flex flex-col justify-end min-h-[250px] text-left">
              ...
              <div className="relative z-10 transition-transform duration-500 group-hover:-translate-y-2">
                 <h3 className="text-3xl font-black text-white italic tracking-tighter leading-none mb-4">Resume Builder</h3>
                 <p className="text-primary-400 text-[10px] font-black uppercase tracking-[0.3em] mb-10 leading-relaxed max-w-[250px]">Use our AI-driven builder to optimize your professional profile.</p>
            ...
            <div className="card bg-white p-10 flex flex-col justify-between shadow-soft group border-none text-left">
              <div>
                 <div className="flex items-center justify-between mb-8">
                    <h3 className="text-xl font-black text-slate-900 italic tracking-tight leading-none">Profile Analytics</h3>
                    <div className="p-3 bg-primary-50 text-primary-600 rounded-2xl">
                       <TrendingUp size={22} />
                    </div>
                 </div>
                 <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Weekly Metric</p>
                 <p className="text-sm font-bold text-slate-600 italic leading-relaxed">Your professional profile has been viewed by <span className="text-slate-900 font-black">28 recruiters</span> in this cycle.</p>
              </div>
        ...
        <div className="lg:col-span-4 space-y-8">
          ...
          <div className="card p-8 border-none bg-white shadow-soft text-left">
            <div className="flex items-center justify-between mb-8">
               <h3 className="text-xl font-black text-slate-900 italic tracking-tight leading-none">Upcoming Interviews</h3>
          ...
          {/* Strategic Actions */}
          <div className="card p-8 border-none bg-white shadow-soft text-left">
            <h3 className="text-xl font-black text-slate-900 italic tracking-tight mb-8 leading-none">Quick Actions</h3>
            <div className="grid grid-cols-1 gap-4">
              {[
                ...
                >
                  ...
                  <span className="text-[11px] font-black uppercase tracking-widest text-slate-600 group-hover:text-slate-900 transition-colors uppercase italic">{action.label}</span>
          ...
          <div className="card bg-gradient-to-br from-primary-50 to-indigo-50 border-none shadow-soft flex flex-col items-center justify-center py-12 px-6">
            ...
            <p className="text-lg font-black text-slate-900 italic tracking-tight">AI Insights</p>
            <p className="text-[10px] font-bold text-primary-600 uppercase tracking-widest mt-2 text-center leading-relaxed">Smart job matching engine activating in next cycle.</p>
          </div>
        </div>
      </div>
                     ...
                     {selectedApp.timeline.map((step, i) => (
                        <div key={i} className="relative">
                           ...
                           <div>
                              ...
                              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mt-1">Last Updated: {step.date}</p>
                           </div>
                        </div>
                     ))}
                  </div>
               ...
               <div className="p-8 bg-slate-50 rounded-[2.5rem] border border-slate-100">
                  <div className="flex items-center justify-between mb-6">
                     <div className="flex items-center gap-3">
                        ...
                        <span className="text-[10px] font-black text-slate-900 uppercase tracking-widest leading-none">Recruiter Feedback</span>
                     </div>
                     <span className="text-[9px] font-black text-slate-300 uppercase tracking-widest">Internal View</span>
                  </div>
                  <p className="text-sm font-bold text-slate-500 italic leading-relaxed">"Candidate matches core visual architecture competencies. Strong system design evidence. Progress to next interview round."</p>
               </div>

               <div className="pt-4 flex gap-4">
                  <button onClick={() => setSelectedApp(null)} className="flex-1 py-4 bg-slate-100 text-slate-600 rounded-[1.5rem] font-black uppercase tracking-widest text-[10px]">Close</button>
                  <button onClick={() => { showToast('Request for status update sent', 'info'); setSelectedApp(null); }} className="flex-2 py-4 bg-slate-900 text-white rounded-[1.5rem] font-black uppercase tracking-widest text-[10px] shadow-xl shadow-slate-200">Request Status Update</button>
               </div>
            </div>
         )}
      </CenterModal>
